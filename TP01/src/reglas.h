#ifndef SRC_REGLAS_H_
#define SRC_REGLAS_H_

#include <string>

/*
 * Descubre las ocurrencias de la letra en la palabra 'secreta' y devuelve la cantidad de apariciones
 */
int descubrir(char letra, std::string &descubierta, std::string secreta);

/*
 * Según la cantidad de ocurrencias de laletraArriesgada en la palabra secreta consume o no una vida
 */
...
/*
 * Devuelve una versión oculta de la palabra
 */
